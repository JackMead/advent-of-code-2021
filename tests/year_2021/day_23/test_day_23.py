...
from src.year_2021.day_23.main import *
import pytest

test_input = load_txt_file('./tests/year_2021/day_23/test_input.txt')
test_input_2 = load_txt_file('./tests/year_2021/day_23/test_input_2.txt')
finished_input = load_txt_file('./tests/year_2021/day_23/finished_input.txt')
