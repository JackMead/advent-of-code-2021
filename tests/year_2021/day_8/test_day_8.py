from src.year_2021.day_8.main import count_recognised_digits_easy, sum_all_output_numbers, get_value, solve_wires, solution_is_valid, Position
from src.helpers.files import load_txt_file

test_input = load_txt_file('./tests/year_2021/day_8/test_input.txt')
