...
from src.year_2021.day_12.main import *

test_input_1 = load_txt_file('./tests/year_2021/day_12/test_input_1.txt')
test_input_2 = load_txt_file('./tests/year_2021/day_12/test_input_2.txt')
test_input_3 = load_txt_file('./tests/year_2021/day_12/test_input_3.txt')
