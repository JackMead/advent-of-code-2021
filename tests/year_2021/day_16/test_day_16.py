...
from src.year_2021.day_16.main import *

test_input = load_txt_file('./tests/year_2021/day_16/test_input.txt')
test_input_2 = load_txt_file('./tests/year_2021/day_16/test_input_2.txt')
