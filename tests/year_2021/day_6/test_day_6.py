from src.year_2021.day_6.main import count_lantern_fish_after_days
from src.year_2021.day_6.main import load_txt_file

test_input = load_txt_file('./tests/year_2021/day_6/test_input.txt')
