from src.year_2021.day_4.main import get_winning_score, get_boards, get_numbers, is_board_finished, mark_number
from src.helpers.files import load_txt_file

test_input = load_txt_file('./tests/year_2021/day_4/test_input.txt')
