...
from src.year_2021.day_22.main import *
import pytest

test_input = load_txt_file('./tests/year_2021/day_22/test_input.txt')
test_input_2 = load_txt_file('./tests/year_2021/day_22/test_input_2.txt')
